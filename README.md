...
* [Class `ActiveRecord`](#class-activerecord)
    * [Static Methods](#static-methods)
      ...
      * [Method `delete_by_id($id)`](#method-deletebyidid)
      * [Method `get([$id])`](#method-getid)
      * [Method `get_{type}_by_{column}($value [, $...])`](#method-gettypebycolumnvalue)
      * [Method `get_table_name()`](#method-gettablename)
    ...
    * [Event methods](#event-methods)
      * [Method `save_pre($isNew)`](#method-savepreisnew)
      * [Method `save_post($isNew)`](#method-savepostisnew)
      * [Method `delete_pre()`](#method-deletepre)
      * [Method `delete_post()`](#method-deletepost)
  * [Class `Query`](#class-query)
    ...
    * [Instance Methods](#instance-methods)
      ...
      * [Method `insert($data)`](#method-insertdata)
      * [Method `where($column [, $type_or_value [, $value]])`](#method-wherecolumn-typeorvalue-value)
      * [Method `and_where($column [, $type_or_value [, $value]])`](#method-andwherecolumn-typeorvalue-value)
      * [Method `or_where($column [, $type_or_value [, $value]])`](#method-orwherecolumn-typeorvalue-value)
      * [Method `group_by($column [, $order])`](#method-groupbycolumn-order)
      * [Method `having($column [, $type_or_value=null [, $value=null]])`](#method-havingcolumn-typeorvaluenull-valuenull)
      * [Method `and_having($column [, $type_or_value [, $value]])`](#method-andhavingcolumn-typeorvalue-value)
      * [Method `or_having($column [, $type_or_value [, $value]])`](#method-orhavingcolumn-typeorvalue-value)
      * [Method `order_by($column [, $order])`](#method-orderbycolumn-order)
      * [Method `limit($limit)`](#method-limitlimit)
      * [Method `offset($offset)`](#method-offsetoffset)
      * [Method `sql()`](#method-sql)
      * [Method `get_results()`](#method-getresults)
      * [Method `get_row()`](#method-getrow)
      * [Method `get_col()`](#method-getcol)
      * [Method `get_var()`](#method-getvar)
      * [Method `get()`](#method-get)
      * [Method `get_one()`](#method-getone)
